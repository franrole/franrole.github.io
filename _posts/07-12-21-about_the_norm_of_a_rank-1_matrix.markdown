...
Let's build a rank-1 matrix as the outer product of two unit vectors:  ${\lVert}X{\rVert}_F = \sqrt{\sum_{k=1}^r}$  $ = \sqrt{\sum_{k=1}^r}$ ${\lVert}X{\rVert}_F$ $\lVert X\rVert_F$
